...
KData::KData(const std::variant<std::monostate, int, double, bool, std::string, KCallable*> &value) : value(value) {}

KData::KData() {
    value = {};
}

std::variant<std::monostate, int, double, bool, std::string, KCallable*> KData::getValue() {
    return value;
}

KData KData::operator-() {
...
KData KData::operator+(KData &other) {
